...
def benchmark_pattern_recognition():
    ...
    test_cases = [
        ...
        # Triples
        ([Card(Suit.SPADES, Rank.QUEEN), Card(Suit.HEARTS, Rank.QUEEN), Card(Suit.CLUBS, Rank.QUEEN)], "Triple"),
        # Bombs
        ([Card(Suit.SPADES, Rank.TEN), Card(Suit.HEARTS, Rank.TEN), Card(Suit.CLUBS, Rank.TEN), Card(Suit.DIAMONDS, Rank.TEN)], "Bomb"),
        # Tongzi
        ([Card(Suit.SPADES, Rank.ACE), Card(Suit.SPADES, Rank.ACE), Card(Suit.SPADES, Rank.ACE)], "Tongzi"),
    ]
